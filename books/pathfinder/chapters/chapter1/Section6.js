...
import pf6 from "../../../../public/images/pathfinder/chapter1/pf6.webp"

export default function Section6(){
  return (
    <>
      <Header type="medium" id="using-this-book">Using This Book</Header>
      <Paragraph>
      ...
      <Header type="small" id="ch1-introduction">Chapter 1: Introduction</Header>
      <Paragraph>
      ...
      <Header type="small" id="ch2-ancestries-and-backgrounds">Chapter 2: Ancestries & Backgrounds</Header>
      <Paragraph>
      ...
      <Header type="small" id="ch3-classes">Chapter 3: Classes</Header>
      <Paragraph>
      ...
      <Header type="small" id="ch4-skills">Chapter 4: Skills</Header>
      <Paragraph>
      ...
      <Header type="small" id="ch5-feats">Chapter 5: Feats</Header>
      <Paragraph>
      ...
      <Header type="small" id="ch6-equipment">Chapter 6: Equipment</Header>
      <Paragraph>
      ...
      <Header type="small" id="ch7-spells">Chapter 7: Spells</Header>
      <Paragraph>
      ...
      <Header type="small" id="ch8-religion-and-deities">Chapter 8: Religion & Deities</Header>
      <Paragraph>
        Characters who venerate a deity should look to this chapter to find the rules associated with their faith.
      </Paragraph>

      <Header type="small" id="ch9-playing-the-game">Chapter 9: Playing the Game</Header>
      <Paragraph>
      ...
      <Header type="small" id="ch10-character-wealth">Chapter 10: Character Wealth</Header>
      <Paragraph>
        This chapter includes rules for allocating treasure for characters who don't start at 1st level.
      </Paragraph>

      <Header type="small" id="ch11-crafting-and-treasure">Chapter 11: Crafting & Treasure</Header>
      <Paragraph>
      ...
      <Header type="small" id="conditions-appendix">Conditions Appendix</Header>
      <Paragraph>
